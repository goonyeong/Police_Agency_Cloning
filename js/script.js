...
// Create map /////////////////////////////////////////////////////////////
function createMap(){
    var mapContainer = document.getElementById('map_police_agency'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.563398, 126.967410), // 지도의 중심좌표
        level: 5 // 지도의 확대 레벨
    };
    ...
    // 마커가 표시될 위치입니다 
    var markerPosition  = new kakao.maps.LatLng(37.563398, 126.967410); 
